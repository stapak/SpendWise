...
import { Car, Home, Utensils, ShoppingCart, Gift, Zap, Activity, ArrowUp, CreditCard, PiggyBank, IndianRupee, ArrowDown, TrendingUp, Clock, RefreshCw, Info, ChevronUp, PieChart } from "lucide-react";
                ...
                <div className={styles.grid.rightColumn}>
                    <div className={styles.cards.base}>
                       ...
                       <div className={styles.transactions.dataStackingInfo}>
                            ...
                            <span>
                                Transaction are stacked by date (newest first)
                            </span>
                       </div>
                       ...
                       <div className={styles.transactions.listContainer}>
                           {displayedTransactions.map((transaction, index) => {
                                if (!transaction || typeof transaction !== "object") {
                                  console.log("BAD ITEM:", transaction, index);
                                  return null;
                                }
                                ...
                                return (
                                  <div key={id} className={styles.transactions.transactionItem}>
                                    <div className="flex items-center md:gap-4 lg:gap-3">
