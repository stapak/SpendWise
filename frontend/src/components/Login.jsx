...
function Login({onLogin, API_URL ="http://localhost:4000"}){
            ...
            if(!profile){
                ...
                if(!profile && token){
                    try{
                        ...
                        console.warn("Could not fetch after login token:",err);
                    }
                }
                ...
                if(typeof onLogin === "function"){
                    try{
                        ...
                        console.warn("onLogin threw:",err);
                        navigate("/");
                    }
                } 
                else{
                    console.log("reached in the else part")
                    navigate("/")
                }
                setPassword("");
