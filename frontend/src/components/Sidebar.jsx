...
function Sidebar({ user, isCollapsed, setIsCollapsed }){
    ...
    const toggleSiderbar = () => setIsCollapsed((c) => !c );
    ...
    return(
        ...
        >
            <div className={sidebarStyles.sidebarInner.base}>
                <button onClick={toggleSiderbar}  className={sidebarStyles.toggleButton.base}>
                    <motion.div
                        initial={{ rotate: 0 }}
        ...
        <AnimatePresence>
            ...
            <div className="relative h-full flex flex-col">
                ...
                <div className={sidebarStyles.mobileFooter}>
                    <Link to="https://www.hexagondigitalservices.com/contact"
