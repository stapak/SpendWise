...
import { sidebarStyles, signupStyles } from '../assets/dummyStyles';
...
const Signup = ({ API_URL = "http://localhost:4000", onSignup }) =>{
    ...
    function persistAuth(profile, token ){
    ...
    // to validate the field is filled or not.
    const validateForm = () => {
    const newErrors = {};
            ...
            <div className={signupStyles.cardContainer}>
                ...
                <div className={signupStyles.formContainer}>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className='mb-6'>
                            <label htmlFor='name' className={signupStyles.labe}>
                                Full Name
                            </label>
                        ...
                        <div className='mb-6'>
                            <label htmlFor='email' className={signupStyles.labe}>
                                email
                            </label>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type='text' 
                                       ...
                                       placeholder='your@SpendWise.com'
                                />
                            </div>
                        ...
                        <div className='mb-6'>
                            <label htmlFor='password' className={signupStyles.labe}>
                                password
                            </label>
