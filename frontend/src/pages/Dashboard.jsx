...
import { ArrowDown, BarChart, PieChart, PiggyBank, Plus, TrendingDown, TrendingUp, Wallet, 
        TrendingUp as ProfitIcon, 
        PieChart as PieChartIcon,
        IndianRupee, ChevronUp, ChevronDown, ShoppingCart 
...
const Dashboard = () =>{
  ...
  const displayedExpense = showAllExpense 
    ...
    return(
     ...
     <AddTransactionModal showModal={showModal}
