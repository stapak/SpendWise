...
function Profile({ onUpdateProfile, onLogout}){
    ...
    const handleApiReqeust = useCallback(async (method, endpoint, data=null)=>{
        ...
        try{
            ...
            console.error(`${method} reqeust error:`,error);
    ...
    useEffect(()=>{
        const fetchUserData = async () =>{
            try{
                const data =await handleApiReqeust("get","/user/me");
                if(data){
    ...
    const handleSaveProfile = async () =>{
        try{
            const data = await handleApiReqeust("put","/user/profile", tempUser);
            if(data){
                ...
                console.log("onupdate profile",onUpdateProfile);
    ...
    const handlePasswordSubmit = async (e) =>{
        ...
        try{
            await handleApiReqeust("put","/user/password",{
